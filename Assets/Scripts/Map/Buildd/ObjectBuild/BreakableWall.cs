...
public class BreakableWall : BuildObj
{
    ...
    {
        Managers.Sound.PlaySound3D(GlobalText.HIT_SOUND, transform.position, 0.35f);
        health -= 1f;
        switch (health)
        {
            case 3f:
    ...
    {
        Managers.Sound.PlaySound3D(GlobalText.ROCK_DESTROY_SOUND, transform.position, 0.35f);
