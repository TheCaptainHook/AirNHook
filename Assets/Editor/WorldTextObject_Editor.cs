...
public class WorldTextObject_Editor : Editor
{
    ...
    SerializedProperty _SerializedProperty_FontSize;
    ...
    private void OnEnable()
    {
        ...
        _SerializedProperty_FontSize = new SerializedObject(_WorldTextObject).FindProperty("fontSize");
        previousFontSize = _SerializedProperty_FontSize.floatValue;
    ...
    public override void OnInspectorGUI()
    {
        ...
        _WorldTextObject.fontSize =  EditorGUILayout.FloatField("Font Size", _WorldTextObject.fontSize);
        ...
        if (GUI.changed)
        {
            ...
            _SerializedProperty_FontSize.floatValue = _WorldTextObject.fontSize;
        }
        ...
        _SerializedProperty_FontSize.serializedObject.ApplyModifiedProperties();
    ...
    private void OnEditorUpdate()
    {
        ...
        float curFontSize = _SerializedProperty_FontSize.floatValue;
    //0926
